model SEACHANGE_TEST_85MCR_batch
  //=============
...
algorithm 
  if generatorsFuelType[currentGenIdx] < 1000 and generatorsFuelType[currentGenIdx] > 800 then  // if the generator is a diesel generator
...
parameter Real P_rated[N] = {gen_1_rated_gen * 1 , gen_2_rated_gen* 0.85, gen_3_rated_gen* 0.85, gen_4_rated_gen* 0.85, gen_5_rated_gen* 0.85, gen_6_rated_gen* 0.85, gen_7_rated_gen* 0.85, gen_8_rated_gen* 0.85, gen_9_rated_gen* 0.85, gen_10_rated_gen* 0.85};
 ...
 // Parameter Temp, local, diesel limit
      parameter Real dieseLimitLocal = 230236000;
parameter Real methanolLimitLocal = 230236000;
...
annotation(
  ...
  Icon(graphics = {Rectangle(fillColor = {255, 255, 255}, lineThickness = 1, extent = {{-100, 100}, {100, -100}}), Rectangle(fillColor = {57, 182, 50}, fillPattern = FillPattern.Cross, extent = {{-60, 60}, {60, -60}}), Text(origin = {1, 4}, extent = {{-41, 28}, {41, -28}}, textString = "12")}, coordinateSystem(extent = {{-120, 120}, {120, -140}})));
    ...
    parameter Real SOC_min = 0.1 "Minimum state of charge" annotation(
      Dialog(group = "Operational constraints"));
    parameter Real smooth_charge_percentage = 0.10 "Width of smooth transition (fraction of full SoC)";
    /*Controller Fuel Tank Related Section*/
    parameter Real controllerDieselLimit = 0;
    parameter Real controllerMethLimit =0;
    parameter Real controllerHydrolimit=0;
    parameter Real controller_generators_fuel_type[10] ={791, 846, 846, 846, 846, 846, 846, 846, 846, 846};
    ...
    Modelica.Blocks.Interfaces.RealOutput generator_2_controller_output annotation(
      Placement(transformation(origin = {110, 70}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {105, 85}, extent = {{-5, -5}, {5, 5}})));
    Modelica.Blocks.Interfaces.RealOutput generator_3_controller_output annotation(
      Placement(transformation(origin = {110, 50}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {105, 75}, extent = {{-5, -5}, {5, 5}})));
    Modelica.Blocks.Interfaces.RealOutput generator_4_controller_output annotation(
      Placement(transformation(origin = {110, 30}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {105, 65}, extent = {{-5, -5}, {5, 5}})));
    Modelica.Blocks.Interfaces.RealOutput generator_5_controller_output annotation(
      Placement(transformation(origin = {110, 10}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {105, 55}, extent = {{-5, -5}, {5, 5}})));
    Modelica.Blocks.Interfaces.RealOutput generator_6_controller_output annotation(
      Placement(transformation(origin = {110, -10}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {105, 45}, extent = {{-5, -5}, {5, 5}})));
    Modelica.Blocks.Interfaces.RealOutput generator_7_controller_output annotation(
      Placement(transformation(origin = {110, -32}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {105, 35}, extent = {{-5, -5}, {5, 5}})));
    Modelica.Blocks.Interfaces.RealOutput generator_9_controller_output annotation(
      Placement(transformation(origin = {110, -70}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {105, 15}, extent = {{-5, -5}, {5, 5}})));
    Modelica.Blocks.Interfaces.RealOutput generator_8_controller_output annotation(
      Placement(transformation(origin = {110, -50}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {105, 25}, extent = {{-5, -5}, {5, 5}})));
    Modelica.Blocks.Interfaces.RealOutput generator_10_controller_output annotation(
      Placement(transformation(origin = {110, -90}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {105, 5}, extent = {{-5, -5}, {5, 5}})));
    Modelica.Blocks.Interfaces.RealOutput generator_1_controller_output annotation(
      Placement(transformation(origin = {110, 90}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {105, 95}, extent = {{-5, -5}, {5, 5}})));
    ...
    /*
                        ...
                        */
    Modelica.Blocks.Sources.RealExpression PowertrainChargingPwr(y = individualControllerCore12_85MCR.P_batt_charge_request) annotation(
    ...
    Modelica.Blocks.Interfaces.RealInput dieselUsageController annotation(
        Placement(transformation(origin = {67, -107}, extent = {{-7, -7}, {7, 7}}, rotation = 90), iconTransformation(origin = {105, -25}, extent = {{-5, -5}, {5, 5}})));
    Modelica.Blocks.Interfaces.RealInput altFuelUsageController annotation(
        Placement(transformation(origin = {75, -107}, extent = {{-7, -7}, {7, 7}}, rotation = 90), iconTransformation(origin = {105, -35}, extent = {{-5, -5}, {5, 5}})));
    Modelica.Blocks.Interfaces.RealInput hydrolUsageController annotation(
        Placement(transformation(origin = {83, -107}, extent = {{-7, -7}, {7, 7}}, rotation = 90), iconTransformation(origin = {105, -45}, extent = {{-5, -5}, {5, 5}})));
  IndividualEngineController.IndividualControllerCore12_85MCR individualControllerCore12_85MCR(
                          gen_1_exist = controller_gen_1_exist, gen_2_exist = controller_gen_2_exist, 
                                gen_3_exist = controller_gen_3_exist, gen_4_exist = controller_gen_4_exist, 
                                gen_5_exist = controller_gen_5_exist, gen_6_exist = controller_gen_6_exist, 
                                gen_7_exist = controller_gen_7_exist, gen_8_exist = controller_gen_8_exist, 
      ...
      Placement(transformation(origin = {-29.6923, 44.4744}, extent = {{-49.6923, -53.8333}, {49.6923, 53.8333}})));
  equation
  ...
  connect(gen_1_controller_optim_upper, individualControllerCore12_85MCR.P_gen_1_Optim_Upper) annotation(
      Line(points = {{-110, 90}, {-90, 90}, {-90, 82}, {-76, 82}}, color = {0, 0, 127}));
  connect(gen_1_controller_optim_lower, individualControllerCore12_85MCR.P_gen_1_Optim_Lower) annotation(
      Line(points = {{-110, 70}, {-84, 70}, {-84, 74}, {-76, 74}}, color = {0, 0, 127}));
  connect(gen_2_controller_optim_upper, individualControllerCore12_85MCR.P_gen_2_Optim_Upper) annotation(
      Line(points = {{-110, 50}, {-90, 50}, {-90, 66}, {-76, 66}}, color = {0, 0, 127}));
  connect(gen_2_controller_optim_lower, individualControllerCore12_85MCR.P_gen_2_Optim_Lower) annotation(
      Line(points = {{-110, 30}, {-88, 30}, {-88, 56}, {-76, 56}}, color = {0, 0, 127}));
  connect(gen_3_controller_optim_upper, individualControllerCore12_85MCR.P_gen_3_Optim_Upper) annotation(
      Line(points = {{-110, 10}, {-94, 10}, {-94, 48}, {-76, 48}}, color = {0, 0, 127}));
  connect(gen_3_controller_optim_lower, individualControllerCore12_85MCR.P_gen_3_Optim_Lower) annotation(
      Line(points = {{-110, -10}, {-92, -10}, {-92, 40}, {-76, 40}}, color = {0, 0, 127}));
  connect(gen_4_controller_optim_upper, individualControllerCore12_85MCR.P_gen_4_Optim_Upper) annotation(
      Line(points = {{-110, -30}, {-90, -30}, {-90, 32}, {-76, 32}}, color = {0, 0, 127}));
  connect(gen_4_controller_optim_lower, individualControllerCore12_85MCR.P_gen_4_Optim_Lower) annotation(
      Line(points = {{-110, -50}, {-88, -50}, {-88, 24}, {-76, 24}}, color = {0, 0, 127}));
  connect(gen_5_controller_optim_upper, individualControllerCore12_85MCR.P_gen_5_Optim_Upper) annotation(
      Line(points = {{-110, -70}, {-86, -70}, {-86, 16}, {-76, 16}}, color = {0, 0, 127}));
  connect(gen_5_controller_optim_lower, individualControllerCore12_85MCR.P_gen_5_Optim_Lower) annotation(
      Line(points = {{-110, -90}, {-82, -90}, {-82, 8}, {-76, 8}}, color = {0, 0, 127}));
  connect(gen_6_controller_optim_upper, individualControllerCore12_85MCR.P_gen_6_Optim_Upper) annotation(
      Line(points = {{-90, 110}, {-90, 98}, {-66, 98}, {-66, 90}}, color = {0, 0, 127}));
  connect(gen_6_controller_optim_lower, individualControllerCore12_85MCR.P_gen_6_Optim_Lower) annotation(
      Line(points = {{-70, 110}, {-70, 98}, {-58, 98}, {-58, 90}}, color = {0, 0, 127}));
  connect(gen_7_controller_optim_upper, individualControllerCore12_85MCR.P_gen_7_Optim_Upper) annotation(
      Line(points = {{-50, 110}, {-50, 90}}, color = {0, 0, 127}));
  connect(gen_7_controller_optim_lower, individualControllerCore12_85MCR.P_gen_7_Optim_Lower) annotation(
      Line(points = {{-30, 110}, {-30, 98}, {-42, 98}, {-42, 90}}, color = {0, 0, 127}));
  connect(gen_8_controller_optim_upper, individualControllerCore12_85MCR.P_gen_8_Optim_Upper) annotation(
      Line(points = {{-10, 110}, {-10, 96}, {-34, 96}, {-34, 90}}, color = {0, 0, 127}));
  connect(gen_8_controller_optim_lower, individualControllerCore12_85MCR.P_gen_8_Optim_Lower) annotation(
      Line(points = {{10, 110}, {10, 98}, {-26, 98}, {-26, 90}}, color = {0, 0, 127}));
  connect(gen_9_controller_optim_upper, individualControllerCore12_85MCR.P_gen_9_Optim_Upper) annotation(
      Line(points = {{30, 110}, {30, 100}, {-18, 100}, {-18, 90}}, color = {0, 0, 127}));
  connect(gen_9_controller_optim_lower, individualControllerCore12_85MCR.P_gen_9_Optim_Lower) annotation(
      Line(points = {{50, 110}, {50, 96}, {-8, 96}, {-8, 90}}, color = {0, 0, 127}));
  connect(gen_10_controller_optim_upper, individualControllerCore12_85MCR.P_gen_10_Optim_Upper) annotation(
      Line(points = {{70, 110}, {70, 98}, {0, 98}, {0, 90}}, color = {0, 0, 127}));
  connect(gen_10_controller_optim_lower, individualControllerCore12_85MCR.P_gen_10_Optim_Lower) annotation(
      Line(points = {{90, 110}, {90, 98}, {8, 98}, {8, 90}}, color = {0, 0, 127}));
  connect(individualControllerCore12_85MCR.gen1_output, generator_1_controller_output) annotation(
      Line(points = {{16, 82}, {50, 82}, {50, 90}, {110, 90}}, color = {0, 0, 127}));
  connect(individualControllerCore12_85MCR.gen2_output, generator_2_controller_output) annotation(
      Line(points = {{16, 74}, {68, 74}, {68, 70}, {110, 70}}, color = {0, 0, 127}));
  connect(individualControllerCore12_85MCR.gen3_output, generator_3_controller_output) annotation(
      Line(points = {{16, 66}, {38, 66}, {38, 50}, {110, 50}}, color = {0, 0, 127}));
  connect(individualControllerCore12_85MCR.gen4_output, generator_4_controller_output) annotation(
      Line(points = {{16, 56}, {50, 56}, {50, 30}, {110, 30}}, color = {0, 0, 127}));
  connect(individualControllerCore12_85MCR.gen5_output, generator_5_controller_output) annotation(
      Line(points = {{16, 48}, {64, 48}, {64, 10}, {110, 10}}, color = {0, 0, 127}));
  connect(individualControllerCore12_85MCR.gen6_output, generator_6_controller_output) annotation(
      Line(points = {{16, 40}, {58, 40}, {58, -10}, {110, -10}}, color = {0, 0, 127}));
  connect(individualControllerCore12_85MCR.gen7_output, generator_7_controller_output) annotation(
      Line(points = {{16, 32}, {74, 32}, {74, -32}, {110, -32}}, color = {0, 0, 127}));
  connect(individualControllerCore12_85MCR.gen8_output, generator_8_controller_output) annotation(
      Line(points = {{16, 24}, {70, 24}, {70, -50}, {110, -50}}, color = {0, 0, 127}));
  connect(individualControllerCore12_85MCR.gen9_output, generator_9_controller_output) annotation(
      Line(points = {{16, 16}, {62, 16}, {62, -70}, {110, -70}}, color = {0, 0, 127}));
  connect(individualControllerCore12_85MCR.gen10_output, generator_10_controller_output) annotation(
      Line(points = {{16, 8}, {64, 8}, {64, -90}, {110, -90}}, color = {0, 0, 127}));
  connect(individualControllerCore12_85MCR.P_battery_1, gainCharingMin.u) annotation(
      Line(points = {{16, -2}, {22, -2}, {22, -4}, {30, -4}}, color = {0, 0, 127}));
  connect(P_load_1, individualControllerCore12_85MCR.P_load_1) annotation(
      Line(points = {{-66, -114}, {-64, -114}, {-64, -10}, {-66, -10}, {-66, -2}}, color = {0, 0, 127}));
  connect(SOC_1, individualControllerCore12_85MCR.SOC_1) annotation(
      Line(points = {{-92, -120}, {-92, -54}, {-58, -54}, {-58, -2}}, color = {0, 0, 127}));
  connect(individualControllerCore12_85MCR.dieselUsageCore, dieselUsageController) annotation(
      Line(points = {{-50, 0}, {-48, 0}, {-48, -82}, {68, -82}, {68, -106}}, color = {0, 0, 127}));
  connect(hydrolUsageController, individualControllerCore12_85MCR.hydroUsageCore) annotation(
      Line(points = {{84, -106}, {82, -106}, {82, -16}, {-40, -16}, {-40, 0}}, color = {0, 0, 127}));
  connect(individualControllerCore12_85MCR.altFuellUsageCore, altFuelUsageController) annotation(
      Line(points = {{-44, 0}, {-44, -76}, {76, -76}, {76, -106}}, color = {0, 0, 127}));
  connect(genMinBSFC1, individualControllerCore12_85MCR.genMostEffPwr1) annotation(
      Line(points = {{-50, -106}, {-52, -106}, {-52, -20}, {-28, -20}, {-28, 2}}, color = {0, 0, 127}));
  connect(individualControllerCore12_85MCR.genMostEffPwr2, genMinBSFC2) annotation(
      Line(points = {{-24, 2}, {-24, -56}, {-42, -56}, {-42, -106}}, color = {0, 0, 127}));
  connect(genMinBSFC3, individualControllerCore12_85MCR.genMostEffPwr3) annotation(
      Line(points = {{-34, -106}, {-34, -34}, {-18, -34}, {-18, 2}}, color = {0, 0, 127}));
  connect(genMinBSFC4, individualControllerCore12_85MCR.genMostEffPwr4) annotation(
      Line(points = {{-26, -106}, {-26, -24}, {-14, -24}, {-14, 2}}, color = {0, 0, 127}));
  connect(genMinBSFC5, individualControllerCore12_85MCR.genMostEffPwr5) annotation(
      Line(points = {{-18, -106}, {-18, -36}, {-10, -36}, {-10, 2}}, color = {0, 0, 127}));
  connect(genMinBSFC6, individualControllerCore12_85MCR.genMostEffPwr6) annotation(
      Line(points = {{-10, -106}, {-10, -34}, {-6, -34}, {-6, 2}}, color = {0, 0, 127}));
  connect(genMinBSFC7, individualControllerCore12_85MCR.genMostEffPwr7) annotation(
      Line(points = {{-2, -106}, {-2, 2}}, color = {0, 0, 127}));
  connect(genMinBSFC8, individualControllerCore12_85MCR.genMostEffPwr8) annotation(
      Line(points = {{6, -106}, {6, -86}, {20, -86}, {20, -18}, {2, -18}, {2, 2}}, color = {0, 0, 127}));
  connect(genMinBSFC9, individualControllerCore12_85MCR.genMostEffPwr9) annotation(
      Line(points = {{14, -106}, {14, -78}, {24, -78}, {24, -12}, {6, -12}, {6, 2}}, color = {0, 0, 127}));
  connect(individualControllerCore12_85MCR.genMostEffPwr10, genMinBSFC10) annotation(
      Line(points = {{10, 2}, {12, 2}, {12, -24}, {22, -24}, {22, -106}}, color = {0, 0, 127}));
    annotation(
      Diagram,
  ...
  model IdealTankSinglePort
    ...
    model TriplePortTank
      ...
      connector FluidPort "Fluid port for low fidelity models in microgrid components"
        replaceable package Medium = SEACHANGE_TEST_85MCR_batch.Fuel.Hydrogen constrainedby SEACHANGE_TEST_85MCR_batch.Fuel.SimpleFuel "Transported medium";
      ...
      /*Fuel*/
      //Fuel model will be referenced From SEACHANGE_TEST_85MCR_batch
      replaceable package Medium = SEACHANGE_TEST_85MCR_batch.Fuel.Hydrogen constrainedby SEACHANGE_TEST_85MCR_batch.Fuel.Templates.SimpleFuel "Transported medium" annotation(
         choicesAllMatching);
...
// Find how many units are required to run
  ...
  package Fuel
    ...
    package compressedhydrogen
      extends SEACHANGE_TEST_85MCR_batch.Fuel.MethanolFuel(LHV = 120e6, rho = 26, rho_liq = 26, MolarMass = 1.00899e-3, Delta_h_evap = 2.01588*1e-3);
  ...
  model Generator
    ...
    model Generator_Base
      ...
      replaceable package Fuel = SEACHANGE_TEST_85MCR_batch.Fuel.Diesel constrainedby SEACHANGE_TEST_85MCR_batch.Fuel.SimpleFuel "Fuel type" annotation(
         choicesAllMatching,
      ...
      FluidPort co2_outlet(redeclare package Medium = SEACHANGE_TEST_85MCR_batch.Fuel.CarbonDioxide, m_flow = -m_flow_CO2) if use_external_co2_sink annotation(
        Placement(transformation(extent = {{-10.0, -110.0}, {10.0, -90.0}}, rotation = 0.0, origin = {0.0, 0.0})));
    protected
...
// for mathematical stability , if constant efficiency is used this variable is not used in computation but it should be assigned with something for numerical balance
  ...
  model Tank "Tank model for gas storage"
    ...
    partial model Tank_base
      ...
      connector FluidPort "Fluid port for low fidelity models in microgrid components"
        replaceable package Medium = SEACHANGE_TEST_85MCR_batch.Fuel.Hydrogen constrainedby SEACHANGE_TEST_85MCR_batchFuel.Templates.SimpleFuel "Transported medium";
        Modelica.Units.SI.Pressure p "Pressure";
        flow Modelica.Units.SI.MassFlowRate m_flow "Mass flow rate";
        annotation(
          Icon(coordinateSystem(preserveAspectRatio = false), graphics = {Ellipse(extent = {{-100, 100}, {100, -100}}, lineColor = {28, 108, 200}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid)}),
      ...
      replaceable package Medium = SEACHANGE_TEST_85MCR_batch.Fuel.compressedhydrogen "Transported Medium" annotation(
        choicesAllMatching);
    ...
    //EndRepositroy
    extends Tank_base(E_store = energyDensity_max*V, redeclare replaceable package Medium = SEACHANGE_TEST_85MCR_batch.Fuel.compressedhydrogen constrainedby SEACHANGE_TEST_85MCR_batch.Fuel.Templates.SimpleFuel);
    //Local Parameters
...
// Connectors
  ...
  model FuelCellEfficiency
    partial model Base
      ...
      replaceable package Medium = SEACHANGE_TEST_85MCR_batch.Fuel.Hydrogen constrainedby SEACHANGE_TEST_85MCR_batch.Fuel.Hydrogen "Transported medium" annotation(
         choicesAllMatching);
...
// Summary
  ...
  //19e6 for methanol LHV, 791 for methanol density , 0.032kg/mol for molar mass
  //120e6 for hydrogen LHV @ 350 bar, 26.1 for hydrogen density 2.4e-3 kg/mol for molar mass
  parameter Modelica.Units.SI.SpecificEnergy generator_FLHV_1 =  19e6"Fuel LHV";
  ...
  parameter Real generator_V_flow_Frat_1 = 10.68e-5;
  parameter Boolean generator_use_fuel_eff_table_1 = true;
  //fuel parameter Generator_Fuel GEN 2
  parameter Modelica.Units.SI.SpecificEnergy generator_FLHV_2 = 23e6 "Fuel LHV";
  parameter Modelica.Units.SI.Density generator_Frho_2 = 791 "Fuel Density KG/M^3";
  parameter Real generator_Frho_liq_2 = 791 "Fuel Liquid Density";
  ...
  parameter Modelica.Units.SI.SpecificEnergy generator_FLHV_3 = 23e6 "Fuel LHV";
  parameter Modelica.Units.SI.Density generator_Frho_3 = 791 "Fuel Density KG/M^3";
  parameter Real generator_Frho_liq_3 = 791 "Fuel Liquid Density";
  parameter Real generator_FcarbonContent_3 = 0.74 "Fuel Carbon Content";
  ...
  parameter Modelica.Units.SI.Density generator_Frho_4 = 791 "Fuel Density KG/M^3";
  parameter Real generator_Frho_liq_4 = 791 "Fuel Liquid Density";
  ...
  /*ENGINE PARAMETER*/
  parameter Real generator_P_rat_1 = 250000;
  ...
  parameter Real generator_P_idle_1 = 25000;
  parameter Real generator_P_idle_2 = 25000;
  ...
  parameter Boolean gen2_is_on = false;
  ...
  parameter Real mCtrl_user_defined_BSFC_percentage_2 =0.001;
  ...
  parameter Real TotalAccessableDieselMass(displayUnit = "kg")  = 23023600 "Total Diesel Fuel Mass On Board";
  parameter Real TotalAccessableAltFuelMass(displayUnit = "kg") = 23023600"Total Alternative Fuel Mass on Board";
  ...
  /*Fuel Tank Type Array*/
  parameter Real mCtrlTankFuelTypeList[10] ={generator_Frho_liq_1, generator_Frho_liq_2, generator_Frho_liq_3,generator_Frho_liq_4, generator_Frho_liq_5,generator_Frho_liq_6, generator_Frho_liq_7,generator_Frho_liq_8, generator_Frho_liq_9, generator_Frho_liq_10};
  ...
  parameter Real BSFC_Curve_1[:, 2] = [25, 356.50; 63, 256.20; 125, 223.70; 188, 212.90; 250, 213.20];
  ...
  parameter Real Engine_Fuel_Consumption_Look_Up_Table_Diesle_1[:, 2] =[0, 0.00; 10, 21.07; 25, 37.85; 50, 66.11; 75, 94.37; 100, 126.00];
  ...
  // Part Battery
  SEACHANGE_TEST_85MCR_batch.BatteryDualControl battery1(eff_charge = battery_Eff_Charge, set_SOC_final_start_ = battery_Set_SOC_Final_Start, SOC_max = mCtrl_SOC_max, SOC_min = mCtrl_SOC_min, capacity = battery_Capacity, P_max = battery_P_max, SOC_start = battery_SOC_start) annotation(
    Placement(transformation(origin = {-60, -138}, extent = {{-18, -18}, {18, 18}})));
  // Part Electrical Untitlity
  SEACHANGE_TEST_85MCR_batch.Converter_ACDC converter_ACDC(efficiency = 1, V_ref_DC = 1, power_nominal = P_nominal, P_max = 10*P_nominal) "Inverter" annotation(
    Placement(transformation(origin = {144, -222}, extent = {{-10, -10}, {10, 10}})));
  SEACHANGE_TEST_85MCR_batch.ElectricalGrid electricalGrid(power_nominal = P_nominal, V_ref = 1000) annotation(
    Placement(transformation(origin = {192, -224}, extent = {{-10, -10}, {10, 10}})));
  SEACHANGE_TEST_85MCR_batch.ElectricLoad electricLoad(use_input = true, load_in = 1000) annotation(
    Placement(transformation(origin = {167, -201}, extent = {{11, -11}, {-11, 11}})));
  SEACHANGE_TEST_85MCR_batch.Transformer transformer(efficiency = 1, power_nominal = P_nominal, P_max = 10*P_nominal) annotation(
  ...
  // Part Controller
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(tableOnFile = true, tableName = "tab1", fileName = "C:/Users/NMS08/seachangepower.tech/Seachange Services Team - Documents/ZeroPropSim/ManualSImulation/FC/DutyCycle/FC_DutyCycle_Include_HotelLoad/2024-04_FC_Cardinal_buoy_maintenance Generator Test_3_10%Slow.txt", verboseRead = true, columns = 2:2) annotation(
  ...
  SEACHANGE_TEST_85MCR_batch.IndividualEngineController individualEngineController(
        controller_gen_1_exist = gen1_is_on, 
        controller_gen_2_exist = gen2_is_on, 
        controller_gen_3_exist = gen3_is_on, 
        controller_gen_4_exist = gen4_is_on, 
        controller_gen_5_exist = gen5_is_on, 
        controller_gen_6_exist = gen6_is_on, 
        controller_gen_7_exist = gen7_is_on, 
        controller_gen_8_exist = gen8_is_on, 
        controller_gen_9_exist = gen9_is_on, 
        controller_gen_10_exist = gen10_is_on, 
        controller_gen_1_idle = generator_P_idle_1, 
        controller_gen_2_idle = generator_P_idle_2, 
        controller_gen_3_idle = generator_P_idle_3, 
        controller_gen_4_idle = generator_P_idle_4, 
        controller_gen_5_idle = generator_P_idle_5, 
        controller_gen_6_idle = generator_P_idle_6, 
        controller_gen_7_idle = generator_P_idle_7, 
        controller_gen_8_idle = generator_P_idle_8, 
        controller_gen_9_idle = generator_P_idle_9, 
        controller_gen_10_idle = generator_P_idle_10, 
        controller_gen_1_rated = generator_P_rat_1, controller_gen_2_rated = generator_P_rat_2, 
        controller_gen_3_rated = generator_P_rat_3, controller_gen_4_rated = generator_P_rat_4, 
        controller_gen_5_rated = generator_P_rat_5, controller_gen_6_rated = generator_P_rat_6, 
        controller_gen_7_rated = generator_P_rat_7, controller_gen_8_rated = generator_P_rat_8, 
        controller_gen_9_rated = generator_P_rat_9, controller_gen_10_rated = generator_P_rat_10, 
        P_controller_rated_battery = battery_P_max,
        controllerDieselLimit = mCtrlDieselConsumptionLimit,
        controllerMethLimit = mCtrlMethanolConsumptionLimit,
        controllerHydrolimit = mCtrlHydroCinsomuptionLimit,
        controller_generators_fuel_type = mCtrlTankFuelTypeList
        ) annotation(
    Placement(transformation(origin = {-170, 60}, extent = {{-38, -38}, {38, 38}})));
  OptimalFuelConsumptionBoundsCalculator_ExternalTable bsfc_table_gen1(
          BSFC_Curve_Default = BSFC_Curve_1, manual_defined_lowerBound = mCtrl_user_defined_lower_bound_diesel_1, 
          manual_defined_upperBound = mCtrl_user_defined_upper_bound_diesel_1, 
          manually_define_bounds = mCtrl_user_defined_Bounds_diesel_1, 
          upper_minimal_bsfc_percentage = mCtrl_user_defined_BSFC_percentage_1,  
          lower_minimal_bsfc_percentage = mCtrl_user_defined_BSFC_percentage_1_lower, 
 ...
 BSFC_Curve_Default = BSFC_Curve_2, manual_defined_lowerBound = mCtrl_user_defined_lower_bound_diesel_2, manual_defined_upperBound = mCtrl_user_defined_upper_bound_diesel_2, manually_define_bounds = mCtrl_user_defined_Bounds_diesel_2, upper_minimal_bsfc_percentage = mCtrl_user_defined_BSFC_percentage_2, lower_minimal_bsfc_percentage = mCtrl_user_defined_BSFC_percentage_2_lower, manual_defined_most_effcient_power = mCtrl_user_defined_most_eff_ouput_2) annotation(
  ...
  Modelica.Blocks.Math.Gain gainDieselLowerBound7(k = 1000) annotation(
    Placement(transformation(origin = {-292, 204}, extent = {{-4, -4}, {4, 4}})));
  ...
  SEACHANGE_TEST_85MCR_batch.Generator generator1(
      power_vs_fuelconsum = Engine_Fuel_Consumption_Look_Up_Table_Diesle_1, 
      V_flow_frat = generator_V_flow_Frat_1, V_flow_fidle = generator_V_flow_Fidle_1, 
      use_const_eff = generator_Use_Const_Off, eta_el_const = generator_Eta_El_Const, fuelConsumptionIsVolumetric = true, 
      m_flow_fidle = generator_M_Flow_Fidle_1, m_flow_frat = generator_M_Flow_FRat_1, 
      P_rat = generator_P_rat_1, FLHV = generator_FLHV_1, Frho = generator_Frho_1, Frho_liq = generator_Frho_liq_1, 
      FcarbonContent = generator_FcarbonContent_1, FMolarMass = generator_MolarMass_1, 
      use_fuel_eff_table = generator_use_fuel_eff_table_1) annotation(
    Placement(transformation(origin = {8, 290}, extent = {{10, -10}, {-10, 10}})));
  SEACHANGE_TEST_85MCR_batch.Generator generator2(
      power_vs_fuelconsum = Engine_Fuel_Consumption_Look_Up_Table_Diesle_2, 
      V_flow_frat = generator_V_flow_Frat_2, 
      V_flow_fidle = generator_V_flow_Fidle_2, use_const_eff = generator_Use_Const_Off, 
      eta_el_const = generator_Eta_El_Const, fuelConsumptionIsVolumetric = true, 
      m_flow_fidle = generator_M_Flow_Fidle_2, m_flow_frat = generator_M_Flow_FRat_2, P_rat = generator_P_rat_2, 
      FLHV = generator_FLHV_2, 
      Frho = generator_Frho_2, Frho_liq = generator_Frho_liq_2, FcarbonContent = generator_FcarbonContent_2, 
      FMolarMass = generator_MolarMass_2, use_fuel_eff_table = generator_use_fuel_eff_table_2) annotation(
    Placement(transformation(origin = {10, 250}, extent = {{10, -10}, {-10, 10}}, rotation = -0)));
  SEACHANGE_TEST_85MCR_batch.Generator generator3(
      power_vs_fuelconsum = Engine_Fuel_Consumption_Look_Up_Table_Diesle_3, 
      V_flow_frat = generator_V_flow_Frat_3, 
      V_flow_fidle = generator_V_flow_Fidle_3, use_const_eff = generator_Use_Const_Off, eta_el_const = generator_Eta_El_Const, 
      fuelConsumptionIsVolumetric = true, 
      m_flow_fidle = generator_M_Flow_Fidle_3, m_flow_frat = generator_M_Flow_FRat_3, P_rat = generator_P_rat_3, FLHV = generator_FLHV_3, Frho = generator_Frho_3,       
      Frho_liq = generator_Frho_liq_3, FcarbonContent = generator_FcarbonContent_3, FMolarMass = generator_MolarMass_3, use_fuel_eff_table = generator_use_fuel_eff_table_3) annotation(
    Placement(transformation(origin = {10, 210}, extent = {{10, -10}, {-10, 10}}, rotation = -0)));
  SEACHANGE_TEST_85MCR_batch.Generator generator4(
      power_vs_fuelconsum = Engine_Fuel_Consumption_Look_Up_Table_Diesle_4, V_flow_frat = generator_V_flow_Frat_4, 
      V_flow_fidle = generator_V_flow_Fidle_4, use_const_eff = generator_Use_Const_Off, eta_el_const = generator_Eta_El_Const, 
      fuelConsumptionIsVolumetric = true, m_flow_fidle = generator_M_Flow_Fidle_4, m_flow_frat = generator_M_Flow_FRat_4, 
      P_rat = generator_P_rat_4, FLHV = generator_FLHV_4, Frho = generator_Frho_4, Frho_liq = generator_Frho_liq_4, 
      FcarbonContent = generator_FcarbonContent_4, FMolarMass = generator_MolarMass_4, use_fuel_eff_table = generator_use_fuel_eff_table_4) annotation(
    Placement(transformation(origin = {10, 170}, extent = {{10, -10}, {-10, 10}}, rotation = -0)));
  SEACHANGE_TEST_85MCR_batch.Generator generator5(power_vs_fuelconsum = Engine_Fuel_Consumption_Look_Up_Table_Diesle_5, V_flow_frat = generator_V_flow_Frat_5, V_flow_fidle = generator_V_flow_Fidle_5, use_const_eff = generator_Use_Const_Off, eta_el_const = generator_Eta_El_Const, fuelConsumptionIsVolumetric = true, m_flow_fidle = generator_M_Flow_Fidle_5, m_flow_frat = generator_M_Flow_FRat_5, P_rat = generator_P_rat_5, FLHV = generator_FLHV_5, Frho = generator_Frho_5, Frho_liq = generator_Frho_liq_5, FcarbonContent = generator_FcarbonContent_5, FMolarMass = generator_MolarMass_5, use_fuel_eff_table = generator_use_fuel_eff_table_5) annotation(
    Placement(transformation(origin = {10, 130}, extent = {{10, -10}, {-10, 10}}, rotation = -0)));
  SEACHANGE_TEST_85MCR_batch.Generator generator6(power_vs_fuelconsum = Engine_Fuel_Consumption_Look_Up_Table_Diesle_6, V_flow_frat = generator_V_flow_Frat_6, V_flow_fidle = generator_V_flow_Fidle_6, use_const_eff = generator_Use_Const_Off, eta_el_const = generator_Eta_El_Const, fuelConsumptionIsVolumetric = true, m_flow_fidle = generator_M_Flow_Fidle_6, m_flow_frat = generator_M_Flow_FRat_6, P_rat = generator_P_rat_6, FLHV = generator_FLHV_6, Frho = generator_Frho_6, Frho_liq = generator_Frho_liq_6, FcarbonContent = generator_FcarbonContent_6, FMolarMass = generator_MolarMass_6, use_fuel_eff_table = generator_use_fuel_eff_table_6) annotation(
    Placement(transformation(origin = {52, 50}, extent = {{10, -10}, {-10, 10}}, rotation = -0)));
  SEACHANGE_TEST_85MCR_batch.Generator generator7(power_vs_fuelconsum = Engine_Fuel_Consumption_Look_Up_Table_Diesle_7, V_flow_frat = generator_V_flow_Frat_7, V_flow_fidle = generator_V_flow_Fidle_7, use_const_eff = generator_Use_Const_Off, eta_el_const = generator_Eta_El_Const, fuelConsumptionIsVolumetric = true, m_flow_fidle = generator_M_Flow_Fidle_7, m_flow_frat = generator_M_Flow_FRat_7, P_rat = generator_P_rat_7, FLHV = generator_FLHV_7, Frho = generator_Frho_7, Frho_liq = generator_Frho_liq_7, FcarbonContent = generator_FcarbonContent_7, FMolarMass = generator_MolarMass_7, use_fuel_eff_table = generator_use_fuel_eff_table_7) annotation(
    Placement(transformation(origin = {52, 10}, extent = {{10, -10}, {-10, 10}}, rotation = -0)));
  SEACHANGE_TEST_85MCR_batch.Generator generator8(power_vs_fuelconsum = Engine_Fuel_Consumption_Look_Up_Table_Diesle_8, V_flow_frat = generator_V_flow_Frat_8, V_flow_fidle = generator_V_flow_Fidle_8, use_const_eff = generator_Use_Const_Off, eta_el_const = generator_Eta_El_Const, fuelConsumptionIsVolumetric = true, m_flow_fidle = generator_M_Flow_Fidle_8, m_flow_frat = generator_M_Flow_FRat_8, P_rat = generator_P_rat_8, FLHV = generator_FLHV_8, Frho = generator_Frho_8, Frho_liq = generator_Frho_liq_8, FcarbonContent = generator_FcarbonContent_8, FMolarMass = generator_MolarMass_8, use_fuel_eff_table = generator_use_fuel_eff_table_8) annotation(
    Placement(transformation(origin = {52, -30}, extent = {{10, -10}, {-10, 10}}, rotation = -0)));
  SEACHANGE_TEST_85MCR_batch.Generator generator9(power_vs_fuelconsum = Engine_Fuel_Consumption_Look_Up_Table_Diesle_9, V_flow_frat = generator_V_flow_Frat_9, V_flow_fidle = generator_V_flow_Fidle_9, use_const_eff = generator_Use_Const_Off, eta_el_const = generator_Eta_El_Const, fuelConsumptionIsVolumetric = true, m_flow_fidle = generator_M_Flow_Fidle_9, m_flow_frat = generator_M_Flow_FRat_9, P_rat = generator_P_rat_9, FLHV = generator_FLHV_9, Frho = generator_Frho_9, Frho_liq = generator_Frho_liq_9, FcarbonContent = generator_FcarbonContent_9, FMolarMass = generator_MolarMass_9, use_fuel_eff_table = generator_use_fuel_eff_table_9) annotation(
    Placement(transformation(origin = {52, -70}, extent = {{10, -10}, {-10, 10}}, rotation = -0)));
  SEACHANGE_TEST_85MCR_batch.Generator generator10(power_vs_fuelconsum = Engine_Fuel_Consumption_Look_Up_Table_Diesle_10, V_flow_frat = generator_V_flow_Frat_10, V_flow_fidle = generator_V_flow_Fidle_10, use_const_eff = generator_Use_Const_Off, eta_el_const = generator_Eta_El_Const, fuelConsumptionIsVolumetric = true, m_flow_fidle = generator_M_Flow_Fidle_10, m_flow_frat = generator_M_Flow_FRat_10, P_rat = generator_P_rat_10, FLHV = generator_FLHV_10, Frho = generator_Frho_10, Frho_liq = generator_Frho_liq_10, FcarbonContent = generator_FcarbonContent_10, FMolarMass = generator_MolarMass_10, use_fuel_eff_table = generator_use_fuel_eff_table_10) annotation(
    Placement(transformation(origin = {52, -110}, extent = {{10, -10}, {-10, 10}}, rotation = -0)));
  SEACHANGE_TEST_85MCR_batch.IdealTankSinglePort idealTankSinglePort1(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = SEACHANGE_TEST_85MCR_batch.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 270}, extent = {{-10, -10}, {10, 10}})));
  SEACHANGE_TEST_85MCR_batch.IdealTankSinglePort idealTankSinglePort2(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = SEACHANGE_TEST_85MCR_batch.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 230}, extent = {{-10, -10}, {10, 10}})));
  SEACHANGE_TEST_85MCR_batch.IdealTankSinglePort idealTankSinglePort3(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = SEACHANGE_TEST_85MCR_batch.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 190}, extent = {{-10, -10}, {10, 10}})));
  SEACHANGE_TEST_85MCR_batch.IdealTankSinglePort idealTankSinglePort4(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = SEACHANGE_TEST_85MCR_batch.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 150}, extent = {{-10, -10}, {10, 10}})));
  SEACHANGE_TEST_85MCR_batch.IdealTankSinglePort idealTankSinglePort5(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = SEACHANGE_TEST_85MCR_batch.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 110}, extent = {{-10, -10}, {10, 10}})));
  SEACHANGE_TEST_85MCR_batch.IdealTankSinglePort idealTankSinglePort6(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = SEACHANGE_TEST_85MCR_batch.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {110, 30}, extent = {{-10, -10}, {10, 10}})));
  SEACHANGE_TEST_85MCR_batch.IdealTankSinglePort idealTankSinglePort7(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = SEACHANGE_TEST_85MCR_batch.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {110, -10}, extent = {{-10, -10}, {10, 10}})));
  SEACHANGE_TEST_85MCR_batch.IdealTankSinglePort idealTankSinglePort8(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = SEACHANGE_TEST_85MCR_batch.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {110, -50}, extent = {{-10, -10}, {10, 10}})));
  SEACHANGE_TEST_85MCR_batch.IdealTankSinglePort idealTankSinglePort9(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = SEACHANGE_TEST_85MCR_batch.Fuel.MethanolFuel) annotation(
  ...
  Modelica.Blocks.Sources.RealExpression Surplus(y = (((if gen1_is_on then generator1.P_out else 0) + (if gen2_is_on then generator2.P_out else 0) + (if gen3_is_on then generator3.P_out else 0) + (if gen4_is_on then generator4.P_out else 0) + (if gen5_is_on then generator5.P_out else 0) + (if gen6_is_on then generator6.P_out else 0) + (if gen7_is_on then generator7.P_out else 0) + (if gen8_is_on then generator8.P_out else 0) + (if gen9_is_on then generator9.P_out else 0) + (if gen10_is_on then generator10.P_out else 0)) + (if battery_P_max > 1 then battery1.P_out*(-1) else 0) - (gain1.y))) annotation(
    Placement(transformation(origin = {-310, -232}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Sources.RealExpression realExpressionController_P_Charge_1(y = individualEngineController.P_charge_1*battery_P_max) annotation(
    Placement(transformation(origin = {-170, -350}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Continuous.Integrator dieselUsageIntegrator annotation(
    Placement(transformation(origin = {-110, -384}, extent = {{-10, -10}, {10, 10}})));
  ...
  y = (
    (if noEvent(generator_Frho_1 < 1000 ) and noEvent(generator_Frho_1 > 792) and gen1_is_on then generator1.outlet_fuel.m_flow else 0) + 
    (if noEvent(generator_Frho_2 < 1000 ) and noEvent(generator_Frho_2 > 792) and gen2_is_on then generator2.outlet_fuel.m_flow else 0) + 
    (if noEvent(generator_Frho_3 < 1000 ) and noEvent(generator_Frho_3 > 792) and gen3_is_on then generator3.outlet_fuel.m_flow else 0) + 
    (if noEvent(generator_Frho_4 < 1000 ) and noEvent(generator_Frho_4 > 792) and gen4_is_on then generator4.outlet_fuel.m_flow else 0) + 
    (if noEvent(generator_Frho_5 < 1000 ) and noEvent(generator_Frho_5 > 792) and gen5_is_on then generator5.outlet_fuel.m_flow else 0) + 
    (if noEvent(generator_Frho_6 < 1000 ) and noEvent(generator_Frho_6 > 792) and gen6_is_on  then generator6.outlet_fuel.m_flow else 0) + 
    (if noEvent(generator_Frho_7 < 1000 ) and noEvent(generator_Frho_7 > 792) and gen7_is_on then generator7.outlet_fuel.m_flow else 0) + 
    (if noEvent(generator_Frho_8 < 1000 ) and noEvent(generator_Frho_8 > 792) and gen8_is_on then generator8.outlet_fuel.m_flow else 0) + 
    (if noEvent(generator_Frho_9 < 1000 ) and noEvent(generator_Frho_9 > 792) and gen9_is_on then generator9.outlet_fuel.m_flow else 0) + 
    (if noEvent(generator_Frho_10 < 1000 ) and noEvent(generator_Frho_10 > 792) and gen10_is_on then generator10.outlet_fuel.m_flow else 0)))  annotation(
  ...
  y = (
  (if noEvent(generator_Frho_1 == 24) and gen1_is_on then generator1.outlet_fuel.m_flow else 0) + 
  (if noEvent(generator_Frho_2 == 24) and gen2_is_on then generator2.outlet_fuel.m_flow else 0) + 
  (if noEvent(generator_Frho_3 == 24) and gen3_is_on then generator3.outlet_fuel.m_flow else 0) + 
  (if noEvent(generator_Frho_4 == 24) and gen4_is_on then generator4.outlet_fuel.m_flow else 0) + 
  (if noEvent(generator_Frho_5 == 24) and gen5_is_on then generator5.outlet_fuel.m_flow else 0) + 
  (if noEvent(generator_Frho_6 == 24) and gen6_is_on then generator6.outlet_fuel.m_flow else 0) + 
  (if noEvent(generator_Frho_7 == 24) and gen7_is_on then generator7.outlet_fuel.m_flow else 0) + 
  (if noEvent(generator_Frho_8 == 24) and gen8_is_on then generator8.outlet_fuel.m_flow else 0) + 
  (if noEvent(generator_Frho_9 == 24) and gen9_is_on then generator9.outlet_fuel.m_flow else 0) + 
  (if noEvent(generator_Frho_10 == 24) and gen10_is_on then generator10.outlet_fuel.m_flow else 0)))  annotation(
...
equation
  ...
  connect(time_expre2.y, combiTable1Ds.u) annotation(
    Line(points = {{295, -276}, {268.5, -276}, {268.5, -274}, {244, -274}}, color = {0, 0, 127}));
  connect(combiTable1Ds.y[1], gain1.u) annotation(
    Line(points = {{221, -274}, {195, -274}, {195, -276}, {171, -276}}, color = {0, 0, 127}));
  ...
  connect(bsfc_table_gen7.pwr_lower_band, gainDieselLowerBound7.u) annotation(
    Line(points = {{-317, 211}, {-306, 211}, {-306, 204}, {-297, 204}}, color = {0, 0, 127}));
  ...
  connect(gainGenMostEffPwr.y, individualEngineController.genMinBSFC1) annotation(
    Line(points = {{-464, 278}, {-350, 278}, {-350, -30}, {-238, -30}, {-238, -56}, {-190, -56}, {-190, 20}, {-191, 20}}, color = {0, 170, 0}, pattern = LinePattern.DashDot, thickness = 1));
  connect(gainGenMostEffPwr2.y, individualEngineController.genMinBSFC2) annotation(
    Line(points = {{-466, 204}, {-244, 204}, {-244, -74}, {-186, -74}, {-186, 20}}, color = {85, 170, 0}, pattern = LinePattern.DashDot, thickness = 1));
  connect(gainGenMostEffPwr3.y, individualEngineController.genMinBSFC3) annotation(
    Line(points = {{-466, 140}, {-232, 140}, {-232, -90}, {-182, -90}, {-182, 20}, {-181, 20}}, color = {85, 170, 0}, pattern = LinePattern.DashDot, thickness = 1));
  connect(gainGenMostEffPwr4.y, individualEngineController.genMinBSFC4) annotation(
    Line(points = {{-466, 76}, {-250, 76}, {-250, -112}, {-176, -112}, {-176, 20}, {-177, 20}}, color = {85, 170, 0}, pattern = LinePattern.DashDot, thickness = 1));
  connect(gainGenMostEffPwr5.y, individualEngineController.genMinBSFC5) annotation(
    Line(points = {{-466, 16}, {-254, 16}, {-254, -132}, {-172, -132}, {-172, 20}}, color = {85, 170, 0}, pattern = LinePattern.DashDot, thickness = 1));
  connect(gainGenMostEffPwr6.y, individualEngineController.genMinBSFC6) annotation(
    Line(points = {{-288, 284}, {-224, 284}, {-224, -74}, {-168, -74}, {-168, 20}}, color = {85, 170, 0}, pattern = LinePattern.DashDot, thickness = 1));
  connect(gainGenMostEffPwr7.y, individualEngineController.genMinBSFC7) annotation(
    Line(points = {{-288, 218}, {-268, 218}, {-268, -26}, {-214, -26}, {-214, -102}, {-164, -102}, {-164, 20}, {-163, 20}}, color = {85, 170, 0}, pattern = LinePattern.DashDot, thickness = 1));
  connect(gainGenMostEffPwr8.y, individualEngineController.genMinBSFC8) annotation(
    Line(points = {{-286, 156}, {-226, 156}, {-226, -162}, {-158, -162}, {-158, 20}, {-159, 20}}, color = {85, 170, 0}, pattern = LinePattern.DashDot, thickness = 1));
  connect(gainGenMostEffPwr9.y, individualEngineController.genMinBSFC9) annotation(
    Line(points = {{-132, 300}, {-112, 300}, {-112, -102}, {-154, -102}, {-154, 20}}, color = {85, 170, 0}, pattern = LinePattern.DashDot, thickness = 1));
  ...
  connect(realExpressionController_P_Charge_1.y, contoller_charing_output.numberPort) annotation(
    Line(points = {{-159, -350}, {-81.5, -350}}, color = {0, 0, 127}));
  ...
  connect(dieselUsageIntegrator.y, realTotalDieselUsage.numberPort) annotation(
    Line(points = {{-99, -384}, {-91.5, -384}, {-91.5, -390}, {-82, -390}}, color = {0, 0, 127}));
  connect(altFuelUsageIntegrator.y, realTotalAltFuelUsage.numberPort) annotation(
    Line(points = {{-99, -420}, {-82, -420}}, color = {0, 0, 127}));
  ...
  connect(realExpressionDieUse.y, dieselUsageIntegrator.u) annotation(
    Line(points = {{-158, -390}, {-141, -390}, {-141, -384}, {-122, -384}}, color = {0, 0, 127}));
  ...
  connect(individualEngineController.dieselUsageController, dieselUsageIntegrator.y) annotation(
    Line(points = {{-130, 50.5}, {-86, 50.5}, {-86, -384}, {-99, -384}}, color = {0, 0, 127}));
  ...
  annotation(
    ...
    __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=NLSanalyticJacobian",
    __OpenModelica_simulationFlags(lv = "LOG_STDOUT,LOG_ASSERT,LOG_STATS", s = "dassl", variableFilter = ".*"));
end SEACHANGE_TEST_85MCR_batch;
